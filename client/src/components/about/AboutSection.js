        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-12">
            <div className="abt-text">
              ...
              <h2>Chúng tôi là <span className="orange-text">Cơm Nhà</span></h2>
              <p>Nhà hàng Cơm Nhà - nơi hội tụ tinh hoa ẩm thực Việt Nam và quốc tế. Với hơn 20 năm kinh nghiệm, chúng tôi tự hào mang đến những trải nghiệm ẩm thực tuyệt vời nhất thông qua những món ăn được chế biến từ nguyên liệu tươi ngon, đảm bảo vệ sinh an toàn thực phẩm.</p>
